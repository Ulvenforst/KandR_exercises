...
void comment_remover(int c) { // Missing to handle comments inside a string or a symbolic constant.
  static int is_comment = 0;  // this should be fixed with a status when getting into a "".
